...
class FoodRepo {
  Future<Foods> getFoods(
      {String? name, String? status, int? pageNumber, int? pageSize}) async {
    try {
      ...
      var res =
          await _apiClient.get('/api/foods', queryParameters: queryParameters);
  ...
  Future<Food> updateFood(
    ...
    try {
      ...
      var res = await _apiClient.put('/api/foods/$id',
          data: formData,
  ...
  Future<bool> createFoodReport(
      {required String staffId,
      required String foodId,
      required double lastQuantity,
